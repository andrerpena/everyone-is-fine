...
- [x] 56. Add social need (satisfied by conversations with other colonists)
...
- [x] 72. Create weapon item types (melee and ranged)
- [x] 73. Create apparel/clothing item types with body part slots
...
- [x] 84. Create work tab UI for managing colonist job priorities
...
- [x] 91. Create dumping zone type (for unwanted items)
- [x] 92. Implement allowed area zones (restrict colonist movement)
...
- [x] 97. Create home zone (auto-expands around buildings, used for cleaning/firefighting)
...
- [x] 152. Implement marriage proposal and wedding ceremony event
